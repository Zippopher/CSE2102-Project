...
public class User 
{
	...
	public Restaurant[] searchName(String name, LinkedList<Restaurant> restaurants)
	{
	...
	public Restaurant[] searchRate(double rate, LinkedList<Restaurant> restaurants)
	{
		double min = rate - 0.5;
		double max = rate + 0.5;
		ArrayList<Restaurant> results = new ArrayList<Restaurant>();
	...
	public Restaurant[] searchPrice(double price, LinkedList<Restaurant> restaurants)
	{
